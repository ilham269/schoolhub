<template>
  <DashboardLayout title="Dashboard Admin" role-label="Admin" :navigation="navigation"
    ...
    <section class="head">
      ...
      <p>14 fitur utama untuk administrator.</p>
    </section>
...
const adminItems = [
  ...
  ['Kelola Soal', 'fas fa-list-ol', 'soal'],
  ...
  ['Kelola Sistem', 'fas fa-gears', 'sistem'],
  ['Laporan', 'fas fa-chart-line', 'laporan'],
]
const navigation = [
...
const metrics = [
  ...
  { label: 'Karyawan', value: '20', note: 'Staf aktif', icon: 'fas fa-id-card', color: 'amber' },
  {
