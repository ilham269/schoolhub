<template>
  <DashboardLayout title="Dashboard Karyawan" role-label="Karyawan" :navigation="navigation">
    <section class="welcome-card">
      <div>
        <span class="eyebrow-dot dark">Administrasi sekolah</span>
        <h2>Selamat datang, {{ user.name || 'Karyawan' }}.</h2>
        <p>Kelola administrasi sekolah dari satu dashboard yang rapi.</p>
      </div>
    ...
    <section class="section-heading">
      <div>
        ...
        <p>Pilih fitur untuk melanjutkan pekerjaan Anda.</p>
      </div>
    </section>
...
const metrics = [
  {
    label: 'Administrasi hari ini',
    value: '24',
    note: '6 perlu ditinjau',
    icon: 'fas fa-folder',
    color: 'green',
  },
  {
...
const features = [
  {
    title: 'Data Siswa',
    description: 'Mengelola data administrasi siswa.',
